...
please use hosts/suse.x86/masmx and hosts/suse.x86/masmz

if they don't work on Ubuntu do build script src/bubuntu natively on your Ubuntu platform
it will be surprising if they don't but you can ask for help


	TimMilesCox@gmx.ch

if your Ubuntu platform is 64 bits, READ THE REST OF THIS PAGE BEFORE REBUILDING ANYTHING
...
masmx 32-bit does much larger arithmetic than 64 bits 
